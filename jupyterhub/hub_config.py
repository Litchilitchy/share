...
c.Authenticator.admin_users = set(['s','root'])

c.Authenticator.whitelist = set(['s','p','m','root'])
...
c.Spawner.args = list()
c.Spawner.args.append('--NotebookApp.session_manager_class=nb2kg.managers.SessionManager')
c.Spawner.args.append('--NotebookApp.kernel_manager_class=nb2kg.managers.RemoteKernelManager')
c.Spawner.args.append('--NotebookApp.kernel_spec_manager_class=nb2kg.managers.RemoteKernelSpecManager')
...
#c.JupyterHub.data_files_path = '/opt/work/conda/share/jupyterhub'
